...
namespace TGPR.Database.Encryption
{
    ...
    internal class HashProvider : IHashProvider
    {
        ...
        private const string Identifier = "$TGPR$DB$";

        private const string IdentifierFormat = Identifier + "{0}${1}$";
        ...
        public string Hash(string password, int iterations)
        {
            ...
            return string.Format(IdentifierFormat, iterations, base64Hash);
        }
        ...
        public bool Verify(string password, string hashedPassword)
        {
            ...
            string[] splittedHashString = hashedPassword.Replace(Identifier, "").Split('$');
