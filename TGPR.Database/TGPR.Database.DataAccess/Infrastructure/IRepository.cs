...
namespace TGPR.Database.DataAccess.Infrastructure
{
    ...
    public interface IDataSourceRepository<TEntity>
        where TEntity : class
    {
        DataSourceResponse<TEntity> Get(DataSourceFilter filter, params Expression<Func<TEntity, bool>>[] additionalFilters);
    }

    public interface IDataSourceRepositoryAsync<TEntity>
        where TEntity : class
    {
        Task<DataSourceResponse<TEntity>> GetAsync(DataSourceFilter filter, params Expression<Func<TEntity, bool>>[] additionalFilters);
    }
        ...
        where TEntity : class
    {
        ...
        /// <summary>
        /// Allows navigation <see cref="TEntity"/> to be modified in the same context.
        /// </summary>
