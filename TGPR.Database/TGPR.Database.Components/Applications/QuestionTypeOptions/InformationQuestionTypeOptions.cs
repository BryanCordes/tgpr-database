...
{
    internal class InformationQuestionTypeOptions : IQuestionTypeOptions
    {
        private readonly IRepositoryFactory _repoFactory;
        private readonly IMapper _mapper;

        public ApplicationQuestionTypeEnum QuestionType => ApplicationQuestionTypeEnum.Information;

        public InformationQuestionTypeOptions(IRepositoryFactory repoFactory, IMapper mapper)
        {
